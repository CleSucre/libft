...
SRCS		= ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
			  ...
			  table${DIRSEP}ft_tabdel_empty.c table${DIRSEP}ft_tabdup.c table${DIRSEP}ft_tablen.c table${DIRSEP}ft_tabjoin.c table${DIRSEP}ft_tabfree.c table${DIRSEP}ft_tabadd.c table${DIRSEP}ft_tabdel.c table${DIRSEP}ft_tabinsert.c table${DIRSEP}ft_tabprint.c \
