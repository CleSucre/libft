...
SRCS		= ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
			  ...
			  ft_substr.c ft_strjoin.c ft_strjoin_list.c ft_charjoin.c ft_strtrim.c ft_split.c ft_split_quote.c ft_strsplit.c ft_str_count_char.c \
			  ...
			  ft_calloc.c ft_putnbr_base_fd.c ft_putlnbr_fd.c ft_strlentab.c ft_realloc.c ft_is_charset.c \
			  ft_putnbr_unsigned_fd.c ft_putpointer_fd.c ft_strreplace.c ft_strsameedge.c ft_count_words.c ft_putnbr_float_fd.c get_lines.c \
			  ft_strndup.c string_lower.c \
